...
Get-ADUser -Filter {(mail -ne "null") -and (Enabled -eq "true")} -Properties Surname,GivenName,mail,telephoneNumber,Title | Select-Object Name,Surname,GivenName,mail,telephoneNumber,Title | Export-Csv -NoTypeInformation -Encoding utf8 -delimiter "," $env:C:\contact.csv
